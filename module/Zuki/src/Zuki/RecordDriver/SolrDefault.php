...
class SolrDefault extends \VuFind\RecordDriver\SolrDefault
{
    ...
    public function getFullTitle()
    {
        return isset($this->fields['title_full'])
            ? $this->fields['title_full'] : parent::getFullTitle();
    }

    /**
     * Get an array of all volume titles containing the record.  Array entries may
    ...
    public function getContents()
    {
        ...
        if (isset($this->fields['title_vol']) && !empty($this->fields['title_vol'])) {
            return $this->fields['title_vol'];
        }
        return array();
    }
}
